...
class Loan(models.Model):
    ...
    interest_rate = models.ForeignKey(LoanProduct, on_delete=models.SET_NULL, null=True, related_name='interest_rate_applied')
    payment_frequency = models.ForeignKey(LoanProduct, on_delete=models.SET_NULL, null=True, related_name='payment_frequency')
    loan_term = models.ForeignKey(LoanProduct, on_delete=models.SET_NULL, null=True, related_name='loan_term_applied')
